...
<div class="middle">
      <div id="login">
        <?php require_once('production/connexion.php'); ?>
          ...
          <fieldset class="clearfix">
            ...
            <p><span class="fa fa-lock"></span><input type="password" id="password" name="password" Placeholder="Password" required></p> <!-- JS because of IE support; better: placeholder="Password" -->
             ...
             <div>
                                ...
                                password?</a></span>
                                <span style="width:50%; text-align:right;  display: inline-block;"><input type="submit"  id="connecter" name="connecter" value="Sign In"></span>
                            </div>
          </fieldset>
